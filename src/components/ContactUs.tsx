      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex justify-center">
          <Image
            ...
            alt="Contact Us"
            // FIX 1: Removed `transform scale-90 md:scale-100` to prevent shrinking on mobile.
            className="w-full max-w-5xl h-auto ml-0 md:ml-[-4rem] lg:ml-[-8rem]"
          />
        </div>

        {/* Main grid for the content sections */}
        {/* FIX 2: Changed `-mt-8` to `mt-4 md:-mt-8` to add space on mobile and keep original layout on desktop. */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8 max-w-5xl mx-auto mt-4 md:-mt-8">
          ...
          <div className="text-center md:text-left md:col-span-1 lg:col-span-1">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link href="/DomainSection" className="text-2xl font-semibold text-gray-300 hover:text-white transition-all duration-300 hover:-translate-y-1 inline-block">
                  Domains
                </Link>
              </li>
              <li>
